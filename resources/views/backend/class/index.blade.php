...
<div class="container-fluid">
            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <div class="prism-toggle">
                        <button class="btn btn-primary label-btn" data-bs-toggle="modal" data-bs-target="#addclass"> <i class="bi bi-plus-circle-dotted label-btn-icon me-2"></i>Add Class </button>
                    </div>
                    {{-- add class modal  --}}
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title" id="exampleModalLabel1">Add New Class</h6>
                            ...
                            <form action="{{ route('class.store') }}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="row gy-3">
                                        <div class="col-xl-12">
                                            <label class="form-label text-default">Class Name</label>
                                            <input type="text" class="form-control form-control-lg" placeholder="Class name" name="class_name">
                                        </div>
                                        <div class="col-xl-12">
                            ...
                            <table class="table text-nowrap table-bordered">
                                ...
                                <tbody>
                                    @foreach ($requests as $request)
                                        <tr>
                                            <td><strong>{{ $request->class_name }}</strong></td>
                                            @if ($request->status == 1)
                                            ...
                                            @endif
                                            <td>
                                                <div class="hstack gap-2 fs-15 flex justify-center text-center items-center justify-content-center">
        ...
        <div class="col-xl-6">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <div class="prism-toggle">
                        <button class="btn btn-primary label-btn" data-bs-toggle="modal"
                        data-bs-target="#exampleModal">
                            <i class="bi bi-plus-circle-dotted label-btn-icon me-2"></i>Add Class
                        </button>
                    </div>
                </div>
                <div class="card-body">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        ...
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-2 flex gap-3 align-items-center justify-content-between ">
                    <button class="btn btn-teal-light btn-border-down" data-bs-toggle="modal"
                    data-bs-target="#exampleModal">Border</button>
