            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Class<span class="badge bg-secondary-transparent ms-2">New</span></span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                        ...
                        <li class="slide">
                            <a href="{{ route('class.index') }}" class="side-menu__item">Class List</a>
                        </li>
                        <li class="slide has-sub">
