            ...
            <div class="card-body p-5">
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-xl-12 mb-2">
                        <label for="signin-password" class="form-label text-default d-block">Password<a href="" class="float-end text-danger">Forget password ?</a></label>
                ...
                <div class="text-center">
                    <p class="fs-12 text-muted mt-3">Dont have an account? <a href="{{ route('dashboard.register') }}" class="text-primary">Sign Up</a></p>
                </div>
            </div>
        </div>
    </div>
